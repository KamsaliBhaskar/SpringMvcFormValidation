...
public class MyController {
	...
	public void headerMessage(Model model){
		model.addAttribute("headerMessage", "Welcome to Bhaskar Technology");
		...
		citesList.add("Hyderbad");
		citesList.add("Amaravathi");
		citesList.add("Mombai");
		citesList.add("Ahamabad");
		citesList.add("Gujarath");
		citesList.add("kasmir");
